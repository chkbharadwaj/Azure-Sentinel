...
|-------------|--------------------------------|--------------------------------------------------------------------------------|
| 3.3.3       | 06-04-2026                     | Added known limitation note about 64 KB field size truncation to *CrowdStrike Falcon Data Replicator (AWS S3)* **Data Connector** description |
