...
|-------------|--------------------------------|--------------------------------------------------------------------|
| 3.2.0       | 03-09-2026                     | Updated Snowflake CCF V2 pollers to ingest individual API result rows, preventing oversized response partitions from exceeding Logs Ingestion API limits. |
